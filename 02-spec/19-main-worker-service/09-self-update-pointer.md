...
1. Confirm `02-spec/14-update/` covers every behaviour summarised in §3 of this file. Diff §3 against `02-spec/14-update/00-overview.md` — any remaining gap blocks deletion.
