...
"Tables": {
  ...
  "AuthMechanism": {
    ...
    "Rows": [
      ...
      { "AuthMechanismCode": "Jwt",     "AuthMechanismLabel": "Worker JWT (RS256)",          "Description": "Per 02-spec/19/12-jwt-delivery-contract.md." },
...
- `02-spec/19-main-worker-service/07-role-based-dashboards.md` — consumer of `Role`/`AccessItem`/`RoleAccessItem`.
- `02-spec/19-main-worker-service/10-worker-bootstrap-protocol.md` §8 — consumer of `WorkerNodeStatus`.
- `02-spec/19-main-worker-service/06-core-api-endpoints.md` §5 — consumer of `AuthMechanism`.
- `02-spec/19-main-worker-service/11-split-db-tier-reconciliation.md` §4 — tier placement.
