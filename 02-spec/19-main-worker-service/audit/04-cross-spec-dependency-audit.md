...
| F-X-08 | BLOCKER | ✅ CLOSED | #11 | MWS prefix (21000-21199) registered in `02-spec/03/03-error-code-registry/01-registry.md`; 30 codes catalogued in `13-error-codes.md` |
