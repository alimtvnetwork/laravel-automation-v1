...
> - All `*At` timestamp columns are now `INTEGER` (epoch seconds, UTC) per `02-spec/04-database-conventions/01-naming-conventions.md` Rule 7.1 v2.
...
| `CorrelationId` | TEXT | NO | Echoes the inbound `X-Correlation-Id` header per `02-spec/04-database-conventions/06-rest-api-format.md` |
