...
|---------|-------------------------|
| `erd-main-db.mmd` | `02-main-server.md` + `02-spec/04-database-conventions/` |
| `erd-worker-split-db.mmd` | `02-spec/05-split-db-architecture/` + `11-split-db-tier-reconciliation.md` |
| `erd-seedable-config.mmd` | `02-spec/06-seedable-config-architecture/` + `14-rbac-and-status-seed.md` |
...
| `seq-push-update.mmd` | `02-spec/14-update/28-worker-push-instruction.md` + `15-tunable-constants.md` |
...
| [`erd-worker-split-db.mmd`](erd-worker-split-db.mmd) | Worker-side split-DB tiers (Root / App / Session). Authoritative rules in `02-spec/05-split-db-architecture/`. |
| [`erd-seedable-config.mmd`](erd-seedable-config.mmd) | Seedable-Config layout shared by both tiers. Authoritative rules in `02-spec/06-seedable-config-architecture/`. |
...
- PascalCase entity and column names (matches `02-spec/04-database-conventions/`).
