...
%% Tier mapping for this spec: 02-spec/19-main-worker-service/11-split-db-tier-reconciliation.md
...
| FU-6 | Back-link from `spec/05` | `02-spec/05-split-db-architecture/01-fundamentals.md` | ⏭ Out of scope for spec/19 — tracked in spec/05 |

---

## 7. Cross-references

- `02-spec/05-split-db-architecture/01-fundamentals.md` — source of truth for all tier semantics.
- `02-spec/19-main-worker-service/03-main-db-schema.md` — Main-side schema, post-FU-2.
- `02-spec/19-main-worker-service/10-worker-bootstrap-protocol.md` — uses §4 provisioning order.
