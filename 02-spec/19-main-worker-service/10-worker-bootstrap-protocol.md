...
Provisioned by the installer (see `02-spec/14-update/18-install-scripts.md`) into the Worker's **Settings tier** DB:
...
- `02-spec/19-main-worker-service/04-worker-routing.md` — uses `WorkerNode` rows seeded here.
- `02-spec/19-main-worker-service/05-auth-and-2fa.md` — JWT verification uses `JwtPublicKeyPem` from §3.2.
- `02-spec/19-main-worker-service/06-core-api-endpoints.md` — §2.5 `/Workers/Register` and `/Workers/{Id}/Heartbeat`.
